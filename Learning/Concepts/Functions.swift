...
//     mySecondFunction()  // calling second function inside first
//     myThirdFunction()
// }
...
// // let name = username  we cannot use username outside because it is private
// getUserName()

// // return
// func returnUserName() -> String {
//     let username: String = "Easha Akram"
//     return username
// }

// let name: String = returnUserName()
...
func subtractNumbers(v1: Int, v2: Int) -> Int {
    return v1 - v2
}

let result = subtractNumbers(v1: number1, v2: number2)

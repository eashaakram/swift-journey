...
// use var when you think you need to change value
someVariable = false


var myNumber = 1.1234 // one time you choose its type double then when you change value its type will be same 
print(myNumber)
myNumber = 2
print(myNumber)
myNumber = 234567
